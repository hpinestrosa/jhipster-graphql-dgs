...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.openapi.jhipstergraphqldgs.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.openapi.jhipstergraphqldgs.repository.UserRepository.USERS_BY_EMAIL_CACHE);

...
import { TitleGraphqlDgsComponent } from './title-graphql-dgs.component';

describe('Component Tests', () => {
  describe('TitleGraphqlDgs Management Component', () => {
    let comp: TitleGraphqlDgsComponent;
    let fixture: ComponentFixture<TitleGraphqlDgsComponent>;
    let service: TitleGraphqlDgsService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [HttpClientTestingModule],
        declarations: [TitleGraphqlDgsComponent],
      })
        .overrideTemplate(TitleGraphqlDgsComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(TitleGraphqlDgsComponent);

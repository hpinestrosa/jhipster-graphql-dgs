...
class ContentTypeResourceIT {
    ...
    public static ContentType createEntity(EntityManager em) {
        ContentType contentType = new ContentType().contentTypeName(DEFAULT_CONTENT_TYPE_NAME);
        return contentType;
    }
    ...
    public static ContentType createUpdatedEntity(EntityManager em) {
        ContentType contentType = new ContentType().contentTypeName(UPDATED_CONTENT_TYPE_NAME);
        return contentType;
    }
    ...
    void checkContentTypeNameIsRequired() throws Exception {
        ...
        // set the field null
        contentType.setContentTypeName(null);
    ...
    @Test
    @Transactional
    void putNewContentType() throws Exception {
        // Initialize the database
        contentTypeRepository.saveAndFlush(contentType);
        ...
        updatedContentType.contentTypeName(UPDATED_CONTENT_TYPE_NAME);
    ...
    void partialUpdateContentTypeWithPatch() throws Exception {
        ...
        partialUpdatedContentType.contentTypeName(UPDATED_CONTENT_TYPE_NAME);

...
import com.openapi.jhipstergraphqldgs.service.mapper.LanguageMapper;
...
class LanguageResourceIT {
    ...
    public static Language createEntity(EntityManager em) {
        Language language = new Language().languageName(DEFAULT_LANGUAGE_NAME);
        return language;
    }
    ...
    public static Language createUpdatedEntity(EntityManager em) {
        Language language = new Language().languageName(UPDATED_LANGUAGE_NAME);
        return language;
    }
    ...
    void putNewLanguage() throws Exception {
        ...
        updatedLanguage.languageName(UPDATED_LANGUAGE_NAME);
